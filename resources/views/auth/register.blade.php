<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="mr-6">
        @csrf
        <div class="flex flex-col items-center text-center mb-4">
            <h1 class="text-3xl font-semibold text-[#117554] sm:text-5xl">Create Account</h1>
            <p class="text-gray-400">Get started by creating your new account</p>
        </div>
        <!-- Name -->
        <div>
