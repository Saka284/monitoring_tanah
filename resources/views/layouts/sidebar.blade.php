<div class="sidebar fixed top-0 left-0 w-20 h-screen flex flex-col items-center bg-green-600 text-white shadow-lg z-50 max-sm:hidden">
    ...
    <div class="sidebar-logo mt-4">
        <a href="#">
            <img src="assets/img/logo_iot.png" alt="Logo" class="w-10 h-10 rounded-full mb-6">
        </a>
    </div>

    <div class="sidebar-icon group mb-6">
        <a href="/dashboard" class="relative flex items-center justify-center w-12 h-12 bg-green-700 rounded-full transition-all duration-100 group-hover:duration-100 group-hover:rounded-lg group-hover:bg-green-800">
